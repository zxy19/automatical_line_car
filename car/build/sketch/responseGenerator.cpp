#line 1 "C:\\Users\\18668\\Desktop\\automatical_line_car\\car\\responseGenerator.cpp"
...
String responseGenerator::getResponseGenerally(Type type, String title, String data, int flag) {
    ...
    case Type::BINARY: {
        ...
        buffer[10] = (len) & (0xff);
        buffer[11] = 0;
        return utils::fromBufferLen(buffer, 6) + title + utils::fromBufferLen(buffer + 7, 4) + data;
    }
    case Type::CSV:
